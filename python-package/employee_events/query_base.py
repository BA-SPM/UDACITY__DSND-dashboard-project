...
class QueryBase(QueryMixin):
    ...
    Subclasses should set the `name` class attribute to the
    corresponding table name (e.g. 'employee' or 'team').
    """
    ...
    # no passed arguments
    def names(self):
        """Default names implementation. Subclasses should override.
